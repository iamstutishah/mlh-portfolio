...
@app.route('/')
def index():
    return render_template('index.html', title="MLH Fellow", url=os.getenv("URL"), headerInfo=headerInfo, aboutMe=aboutMe, education=education, workExperience=workExperience)
